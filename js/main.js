(function () {
  ...
  const i18n = {
    ...
    'proyectos.html': [
      ...
      { selector: '.card[data-project="galaxy-surf"] .project-preview-link', attr: 'aria-label', es: 'Abrir proyecto Galaxy Surf', en: 'Open Galaxy Surf project' },
      { selector: '.card[data-project="b2b-logistica"] .project-preview-link', attr: 'aria-label', es: 'Abrir proyecto Plataforma B2B Logistica', en: 'Open B2B Logistics Platform project' },
      { selector: '.card[data-project="ecommerce-premium"] .project-preview-link', attr: 'aria-label', es: 'Abrir proyecto Ecommerce de Decoracion Premium', en: 'Open Premium Decor Ecommerce project' },
      { selector: '.card[data-project="legal-firma"] .project-preview-link', attr: 'aria-label', es: 'Abrir proyecto Sitio Institucional para Firma Legal', en: 'Open Institutional Website for Legal Firm project' },
      { selector: '.card[data-project="saas-launch"] .project-preview-link', attr: 'aria-label', es: 'Abrir proyecto Landing de Lanzamiento SaaS', en: 'Open SaaS Launch Landing project' },
      { selector: '.card[data-project="portal-medico"] .project-preview-link', attr: 'aria-label', es: 'Abrir proyecto Portal de Servicios Medicos', en: 'Open Medical Services Portal project' },
      { selector: '.card[data-project="galaxy-surf"] h3', es: 'Galaxy Surf', en: 'Galaxy Surf' },
      { selector: '.card[data-project="galaxy-surf"] p', html: true, es: '<strong>Objetivo:</strong> probar mis habilidades y crear una experiencia web inspirada por las estrellas y la energia del surf.<br /><strong>Mi rol:</strong> diseño y desarrollo completo del proyecto, con foco en identidad visual, narrativa y navegacion clara.<br /><strong>Enfoque de diseno:</strong> atmósfera estelar, estilo premium y estructura visual pensada para destacar la propuesta de marca.<br /><strong>Percepcion lograda:</strong> una web con personalidad propia, inspirada en el cosmos y con una presencia digital mas memorable.', en: '<strong>Goal:</strong> test my skills and create a web experience inspired by the stars and the energy of surfing.<br /><strong>My role:</strong> full design and development of the project, focused on visual identity, storytelling, and clear navigation.<br /><strong>Design approach:</strong> stellar atmosphere, premium styling, and a visual structure designed to highlight the brand proposal.<br /><strong>Outcome:</strong> a website with its own personality, inspired by the cosmos and a much more memorable digital presence.' },
      { selector: '.card[data-project="b2b-logistica"] .project-preview-placeholder', es: 'Preview pendiente: agrega la captura en assets/img/previews/plataforma-b2b-logistica.png', en: 'Preview pending: add screenshot at assets/img/previews/plataforma-b2b-logistica.png' },
      { selector: '.card[data-project="ecommerce-premium"] .project-preview-placeholder', es: 'Preview pendiente: agrega la captura en assets/img/previews/ecommerce-decoracion-premium.png', en: 'Preview pending: add screenshot at assets/img/previews/ecommerce-decoracion-premium.png' },
      { selector: '.card[data-project="legal-firma"] .project-preview-placeholder', es: 'Preview pendiente: agrega la captura en assets/img/previews/sitio-institucional-legal.png', en: 'Preview pending: add screenshot at assets/img/previews/sitio-institucional-legal.png' },
      { selector: '.card[data-project="saas-launch"] .project-preview-placeholder', es: 'Preview pendiente: agrega la captura en assets/img/previews/landing-lanzamiento-saas.png', en: 'Preview pending: add screenshot at assets/img/previews/landing-lanzamiento-saas.png' },
      { selector: '.card[data-project="portal-medico"] .project-preview-placeholder', es: 'Preview pendiente: agrega la captura en assets/img/previews/portal-servicios-medicos.png', en: 'Preview pending: add screenshot at assets/img/previews/portal-servicios-medicos.png' },
      { selector: '.card[data-project="b2b-logistica"] h3', es: 'Plataforma B2B Logistica (via agencia)', en: 'B2B Logistics Platform (agency work)' },
      { selector: '.card[data-project="b2b-logistica"] p', html: true, es: '<strong>Objetivo:</strong> aumentar solicitudes de cotizacion desde desktop y mobile.<br /><strong>Mi rol:</strong> desarrollo web completo de la capa publica y seccion de captacion.<br /><strong>Enfoque de diseno:</strong> arquitectura de contenido, interfaz modular y flujo de captacion claro.<br /><strong>Percepcion lograda:</strong> propuesta comercial mas ordenada, confiable y facil de accionar.', en: '<strong>Goal:</strong> increase quote requests from desktop and mobile users.<br /><strong>My role:</strong> full web development of the public layer and lead-capture section.<br /><strong>Design approach:</strong> content architecture, modular interface, and a clear lead-capture flow.<br /><strong>Perceived outcome:</strong> a clearer, more trustworthy, and action-oriented commercial proposal.' },
      { selector: '.card[data-project="ecommerce-premium"] h3', es: 'Ecommerce de Decoracion Premium (via agencia)', en: 'Premium Decor Ecommerce (agency work)' },
      { selector: '.card[data-project="ecommerce-premium"] p', html: true, es: '<strong>Objetivo:</strong> reducir abandono en fichas de producto y checkout mobile.<br /><strong>Mi rol:</strong> implementacion de front-end y mejora integral de experiencia de compra.<br /><strong>Enfoque de diseno:</strong> jerarquia visual de producto, lectura guiada y compra sin friccion.<br /><strong>Percepcion lograda:</strong> experiencia mas fluida, elegante y orientada a decision de compra.', en: '<strong>Goal:</strong> reduce drop-off on product pages and mobile checkout.<br /><strong>My role:</strong> front-end implementation and full purchase-experience improvement.<br /><strong>Design approach:</strong> product visual hierarchy, guided reading, and frictionless purchasing flow.<br /><strong>Perceived outcome:</strong> a smoother, more premium, and purchase-oriented experience.' },
      { selector: '.card[data-project="legal-firma"] h3', es: 'Sitio Institucional para Firma Legal (via agencia)', en: 'Institutional Website for Legal Firm (agency work)' },
      { selector: '.card[data-project="legal-firma"] p', html: true, es: '<strong>Objetivo:</strong> elevar percepcion de marca y ordenar servicios complejos.<br /><strong>Mi rol:</strong> desarrollo completo del sitio y sistema de secciones editoriales.<br /><strong>Enfoque de diseno:</strong> estructura por perfiles de cliente y narrativa institucional clara.<br /><strong>Percepcion lograda:</strong> marca mas solida, servicios mas comprensibles y mayor sensacion de respaldo.', en: '<strong>Goal:</strong> elevate brand perception and structure complex services.<br /><strong>My role:</strong> full website development and editorial section system.<br /><strong>Design approach:</strong> client-profile architecture and a clear institutional narrative.<br /><strong>Perceived outcome:</strong> a stronger brand impression, clearer services, and greater trust.' },
      { selector: '.card[data-project="saas-launch"] h3', es: 'Landing de Lanzamiento SaaS (via agencia)', en: 'SaaS Launch Landing (agency work)' },
      { selector: '.card[data-project="saas-launch"] p', html: true, es: '<strong>Objetivo:</strong> comunicar propuesta tecnica compleja en una narrativa simple.<br /><strong>Mi rol:</strong> desarrollo de landing completa y microinteracciones de apoyo comercial.<br /><strong>Enfoque de diseno:</strong> bloques por beneficio, scroll guiado y CTA por etapa de decision.<br /><strong>Percepcion lograda:</strong> mensaje tecnico mas claro, dinamico y facil de convertir en interes.', en: '<strong>Goal:</strong> communicate a complex technical offer through a simple narrative.<br /><strong>My role:</strong> full landing development and commercial-support microinteractions.<br /><strong>Design approach:</strong> benefit-led sections, guided scroll, and decision-stage CTAs.<br /><strong>Perceived outcome:</strong> a clearer, more dynamic message that is easier to convert into interest.' },
      { selector: '.card[data-project="portal-medico"] h3', es: 'Portal de Servicios Medicos (via agencia)', en: 'Medical Services Portal (agency work)' },
      { selector: '.card[data-project="portal-medico"] p', html: true, es: '<strong>Objetivo:</strong> facilitar la busqueda de servicios y mejorar confianza del usuario final.<br /><strong>Mi rol:</strong> desarrollo web integral y optimizacion de experiencia en mobile first.<br /><strong>Enfoque de diseno:</strong> navegacion por intencion, lectura amigable y jerarquia clinica clara.<br /><strong>Percepcion lograda:</strong> uso mas intuitivo, mayor confianza y recorrido mas estable en la plataforma.', en: '<strong>Goal:</strong> make service discovery easier and increase end-user trust.<br /><strong>My role:</strong> end-to-end web development and mobile-first experience optimization.<br /><strong>Design approach:</strong> intent-based navigation, friendly readability, and clear clinical hierarchy.<br /><strong>Perceived outcome:</strong> a more intuitive journey, stronger trust, and a steadier platform experience.' },
