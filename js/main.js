(function () {
  ...
  const i18n = {
    ...
    'proyectos.html': [
      ...
      { selector: '.card:nth-child(5) p', html: true, es: '<strong>Objetivo:</strong> facilitar la busqueda de servicios y mejorar confianza del usuario final.<br /><strong>Mi rol:</strong> desarrollo web integral y optimizacion de experiencia en mobile first.<br /><strong>Enfoque de diseno:</strong> navegacion por intencion, lectura amigable y jerarquia clinica clara.<br /><strong>Percepcion lograda:</strong> uso mas intuitivo, mayor confianza y recorrido mas estable en la plataforma.', en: '<strong>Goal:</strong> make service discovery easier and increase end-user trust.<br /><strong>My role:</strong> end-to-end web development and mobile-first experience optimization.<br /><strong>Design approach:</strong> intent-based navigation, friendly readability, and clear clinical hierarchy.<br /><strong>Perceived outcome:</strong> a more intuitive journey, stronger trust, and a steadier platform experience.' },
